...
Folder: `basic-nodejs-dockerfile`
...
Folder: `basic-nodejs-bind-mount`
...
```bash
cd exercies/basic-nodejs-bind-mount
# build image
docker build -t my-node-dev-app .
# run container
docker run -p 8080:8080 -v $PWD:/home/node/app my-node-dev-app
# check output
curl -i localhost:8080
